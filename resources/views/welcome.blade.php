        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-6">
                    <div class="shop">
                        <div class="shop-img">
                            <img src="/site/img/shop01.png" alt="">
                        </div>
                        <div class="shop-body">
                ...
                <div class="col-md-4 col-xs-6">
                    <div class="shop">
                        <div class="shop-img">
                            <img src="/site/img/shop02.png" alt="">
                        </div>
                        <div class="shop-body">
                                    ...
                                    @foreach($latestProducts as $latestProduct)
                                        ...
                                        <div class="product">
                                            <div class="product-img">
                                                <img src="{{ asset($latestProduct->img) }}" alt="">
                                            ...
                                            <div class="product-body">
                                                {{--                                            <p class="product-category">{{ $categories[$latestProduct->category_id]->name }}</p>--}}
                                                <h3 class="product-name"><a href="#">{{ $latestProduct->name }}</a></h3>
                                                <h4 class="product-price">${{ $latestProduct->price / 100 }}
                        ...
                        <div class="products-tabs">
                            ...
                            <div id="tab2" class="tab-pane fade in active">
                                <div class="products-slick" data-nav="#slick-nav-2">
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="/site/img/product07.png" alt="">
                                            <div class="product-label">
                                                <span class="new">NEW</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product">
                                        <div class="product-img">
                                            <img src="/site/img/product09.png" alt="">
                                        </div>
                                        <div class="product-body">
                                            <p class="product-category">Category</p>
                                            <h3 class="product-name"><a href="#">product name goes here</a></h3>
